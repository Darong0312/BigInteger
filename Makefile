...
BigIntegerTest: BigIntegerTest.o $(ADT1_OBJECT) $(ADT2_OBJECT)
	$(LINK) BigIntegerTest BigIntegerTest.o $(ADT1_OBJECT) $(ADT2_OBJECT)
...
BigIntegerTest.o: BigIntegerTest.cpp $(ADT1_HEADER) $(ADT2_HEADER)
